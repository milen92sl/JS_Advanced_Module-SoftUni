...
describe("Repository", function () {
    ...
    describe('Update', () => {
        it('Should work when update one valid entity with another', () => {
            let newEntity = {
                name: "Gosho",
                age: 32,
    ...
    describe('Delete', () => {
        it('Should work when delete one valid entity', () => {
        ...
        it('Should throw error when deleting entity on invalid id', () => {
            ...
            expect(() => repo.del(2, entity)).to.throw(Error, `Entity with id: 2 does not exist!`)
        });
    });
});
